...
export class CateraPrestamosService {
  ...
  getCarteraPrestamosPaginados(page: number, limit: number, search?: string, moneda?: string, producto?: string, periodo?: string, condicion?: string): Observable<any> {
  ...
  getCarteraPrestamosParaExportar(search?: string, moneda?: string, producto?: string, periodo?: string, condicion?: string): Observable<any[]> {
